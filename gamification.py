...
BADGES = {
    # Lifetime volume — 'how' thresholds mirror VOLUME_BADGES below.
    '72o':   {'name': '7-2 Offsuit',     'title': 'The Grind Begins',   'how': '1,000 lifetime hands imported'},
    '44':    {'name': 'Pocket Fours',    'title': 'The Sailboats',      'how': '10,000 lifetime hands imported'},
    'JJ':    {'name': 'Pocket Jacks',    'title': 'Mid-Tier Reg',       'how': '25,000 lifetime hands imported'},
    'QQ':    {'name': 'Pocket Queens',   'title': 'The Ladies',         'how': '50,000 lifetime hands imported'},
    'KK':    {'name': 'Pocket Kings',    'title': 'Volume Crusher',     'how': '100,000 lifetime hands imported'},
    'AK':    {'name': 'A-K',             'title': 'Big Slick',          'how': '250,000 lifetime hands imported'},
    'AA':    {'name': 'Pocket Aces',     'title': 'The Legend',         'how': '500,000 lifetime hands imported'},
    'AA88':  {'name': 'A-A-8-8',         'title': "Dead Man's Hand",    'how': '1,000,000 lifetime hands imported'},
    'AAAA':  {'name': 'Quad Aces',       'title': 'Untouchable',        'how': '2,000,000 lifetime hands imported'},
    'BWAY':  {'name': 'Broadway',        'title': 'Highest Straight',   'how': '5,000,000 lifetime hands imported'},
    'NUTS':  {'name': 'The Nuts',        'title': 'Absolute Legend',    'how': '10,000,000 lifetime hands imported'},
    # Behavioural
    'K9':    {'name': 'K-9',             'title': 'Break Master',
              'how': 'Import during the :55-:00 break window on 5 consecutive days'},
    'A2345': {'name': 'A-2-3-4-5',       'title': 'Rapid Fire',
              'how': '4th import inside a rolling 60-minute window'},
    'STEEL': {'name': 'Steel Wheel',     'title': 'Vampire Grinder',
              'how': 'Import a hand history between 2am and 5am (local time)'},
    'T2':    {'name': '10-2',            'title': 'The Comeback',
              'how': "This week's hand volume more than 1.5x last week's"},
    'ROYAL': {'name': 'Royal Flush',     'title': 'Flawless Week',
              'how': 'Reach a 7-day (or longer) import streak'},
    'Q7':    {'name': 'Q-7',             'title': 'The Machine',
              'how': '10+ imports inside a rolling 24-hour window'},
    'J4':    {'name': 'J-4',             'title': 'The Wildcard',
              'how': 'Import a batch of exactly 15 new hands (the minimum import threshold)'},
    '99':    {'name': '9-9',             'title': 'The Closer',
              'how': 'Import in the last 5 minutes before the daily reset (23:55+ local)'},
    '83':    {'name': '8-3',             'title': 'The Ghost',
              'how': 'Return after exactly 7 full silent days since your last import'},
    '23o':   {'name': '2-3 Offsuit',     'title': 'The Downswing',
              'how': 'Break an import streak of 10 or more consecutive days'},
    # Weekly podium — 'how' ranks mirror PODIUM below.
    'SF':    {'name': 'Straight Flush',  'title': 'Weekly Champion',    'how': 'Finish #1 in weekly points'},
    'QUADS': {'name': 'Four of a Kind',  'title': 'Weekly Runner-Up',   'how': 'Finish #2 in weekly points'},
    'BOAT':  {'name': 'Full House',      'title': 'Weekly Third',       'how': 'Finish #3 in weekly points'},
}
